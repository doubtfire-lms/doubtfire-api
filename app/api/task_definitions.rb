  ...
  class TaskDefinitions < Grape::API
    ...
    get '/units/:unit_id/task_definitions/:task_def_id/tasks' do
      ...
      unit.student_tasks.
        joins(:project).
        joins(:task_status).
        select("projects.tutorial_id as tutorial_id", "project_id", "tasks.id as id", "task_definition_id", "task_statuses.name as status_name", "completion_date", "times_assessed", "times_submitted").
