...
class UnitSerializer < ActiveModel::Serializer
  attributes :code, :id, :name, :my_role, :main_convenor_id, :description, :teaching_period_id, :start_date, :end_date, :active, :draft_task_definition_id, :convenors, :ilos, :auto_apply_extension_before_deadline, :send_notifications, :group_memberships
