class NotificationsMailer < ApplicationMailer
  ...
  def weekly_student_summary(project, summary_stats, did_revert_to_pass)
    ...
    @staff_engagements = @engagements.select { |e| [TaskStatus.complete.name, TaskStatus.feedback_exceeded.name, TaskStatus.redo.name, TaskStatus.discuss.name, TaskStatus.discuss_check.name, TaskStatus.demonstrate.name, TaskStatus.fail.name].include? e.engagement }.count
