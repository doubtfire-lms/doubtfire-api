...
class Unit < ApplicationRecord
  ...
  def days_awaiting_feedback_by_tutorial_csv
    CSV.generate() do |csv|
      ...
      .select('users.username AS username', 'users.first_name AS first_name', 'users.last_name AS last_name', 'tasks.id as task_id', 'task_definitions.abbreviation as task_abbr', 'tasks.project_id as project_id', 'DATEDIFF(CURDATE(),submission_date) AS days_since_submission', 'tutorial_id', 'unit_role_id')
