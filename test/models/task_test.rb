  ...
  def test_pdf_creation_with_gif
    ...
    def test_pdf_creation_with_ipynb
      ...
      td = TaskDefinition.new({
          ...
          restrict_status_updates: false,
          upload_requirements: [ { "key" => 'file0', "name" => 'A JupyterNotebook', "type" => 'code' } ],
          plagiarism_warn_pct: 0.8,
          is_graded: false,
          max_quality_pts: 0
        })
    ...
    data_to_post = with_file('test_files/submissions/aaaa.ipynb', 'code/ipynb', data_to_post)
