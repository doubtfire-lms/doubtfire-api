...
class StatusTest < ActiveSupport::TestCase
  ...
  def test_status_comments
    ...
    assert rtm_comment.read_by?(main_tutor), 'Error: TE status comment should be read by the tutor'

    # Task status comments by staff is not marked read by students
    assert te_comment.read_by?(main_tutor), 'Error: TE status comment should be read by the tutor'
