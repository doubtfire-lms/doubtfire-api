...
class UnitsTest < MiniTest::Test
  ...
  def test_units_post
    ...
    post '/api/units.json', '{"name":"Intro to Social Skills", "code":"JRRW40003", "start_date":"2016-05-14T00:00:00.000Z", "end_date":"2017-05-14T00:00:00.000Z", "auth_token": "#{@auth_token}"}', "CONTENT_TYPE" => 'application/json'
