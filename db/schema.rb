...
ActiveRecord::Schema[8.0].define(version: 20_250_819_001_800) do
  ...
  create_table "marking_sessions", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index %w[marker_id unit_id ip_address updated_at], name: "index_marking_sessions_on_user_unit_ip_and_time"
