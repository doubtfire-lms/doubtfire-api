...
ActiveRecord::Schema.define(version: 20191021024416) do
  ...
  add_index "enrolments", ["tutorial_id", "project_id"], name: "index_enrolments_on_tutorial_id_and_project_id", unique: true, using: :btree
  ...
  add_index "unit_activity_sets", ["activity_type_id", "unit_id"], name: "index_unit_activity_sets_on_activity_type_id_and_unit_id", unique: true, using: :btree
