...
ActiveRecord::Schema[7.0].define(version: 2023_02_10_032515) do
  ...
  create_table "messages", charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    ...
    t.index ["assessor_id"], name: "index_messages_on_assessor_id"
    t.index ["discussion_comment_id"], name: "index_messages_on_discussion_comment_id"
    t.index ["overseer_assessment_id"], name: "index_messages_on_overseer_assessment_id"
    ...
    t.index ["task_status_id"], name: "index_messages_on_task_status_id"
