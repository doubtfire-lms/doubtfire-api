...
ActiveRecord::Schema.define(version: 20210624023700) do
  ...
  create_table "breaks", force: :cascade do |t|
    ...
    t.integer  "number_of_weeks",    limit: 4, null: false
    t.integer  "teaching_period_id", limit: 4
  end
  ...
  create_table "comments_read_receipts", force: :cascade do |t|
    t.integer  "task_comment_id", limit: 4, null: false
  ...
  create_table "discussion_comments", force: :cascade do |t|
    ...
    t.integer  "number_of_prompts", limit: 4
    t.datetime "created_at",                  null: false
    t.datetime "updated_at",                  null: false
  end
  ...
  create_table "group_submissions", force: :cascade do |t|
    ...
    t.integer  "submitted_by_project_id", limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "groups", force: :cascade do |t|
    t.integer  "group_set_id",        limit: 4
    t.integer  "tutorial_id",         limit: 4
    t.string   "name",                limit: 255
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "capacity_adjustment", limit: 4,   default: 0,     null: false
    t.boolean  "locked",                          default: false, null: false
  end
  ...
  create_table "plagiarism_match_links", force: :cascade do |t|
    t.integer  "task_id",               limit: 4
    t.integer  "other_task_id",         limit: 4
    t.integer  "pct",                   limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "task_comments", force: :cascade do |t|
    ...
    t.integer  "discussion_comment_id",     limit: 4
  ...
  create_table "task_definitions", force: :cascade do |t|
    ...
    t.integer  "plagiarism_warn_pct",     limit: 4,                   default: 50
    t.integer  "group_set_id",            limit: 4
    t.datetime "due_date"
    t.datetime "start_date",                                                          null: false
    t.boolean  "is_graded",                                           default: false
    t.integer  "max_quality_pts",         limit: 4,                   default: 0
    t.integer  "tutorial_stream_id",      limit: 4
    t.boolean  "assessment_enabled",                                  default: false
    t.integer  "overseer_image_id",       limit: 4
  end

  add_index "task_definitions", ["overseer_image_id"], name: "index_task_definitions_on_overseer_image_id", using: :btree
  ...
  add_index "task_pins", ["user_id"], name: "fk_rails_915df186ed", using: :btree
  ...
  create_table "tasks", force: :cascade do |t|
    ...
    t.integer  "max_pct_similar",      limit: 4,   default: 0
    t.integer  "group_submission_id",  limit: 4
    t.integer  "contribution_pct",     limit: 4,   default: 100
    t.integer  "times_assessed",       limit: 4,   default: 0
    t.datetime "submission_date"
    t.datetime "assessment_date"
    t.integer  "grade",                limit: 4
    t.integer  "contribution_pts",     limit: 4,   default: 3
    t.integer  "quality_pts",          limit: 4,   default: -1
    t.integer  "extensions",           limit: 4,   default: 0,    null: false
  end
  ...
  create_table "tutorial_enrolments", force: :cascade do |t|
    ...
    t.integer  "tutorial_id", limit: 4, null: false
  end
  ...
  add_index "tutorial_streams", ["activity_type_id"], name: "fk_rails_14ef80da76", using: :btree
  ...
  create_table "tutorials", force: :cascade do |t|
    ...
    t.integer  "unit_role_id",       limit: 4
    t.string   "abbreviation",       limit: 255
  ...
  create_table "units", force: :cascade do |t|
    ...
    t.integer  "teaching_period_id",                   limit: 4
    t.integer  "main_convenor_id",                     limit: 4
    ...
    t.integer  "draft_task_definition_id",             limit: 4
    t.boolean  "allow_student_extension_requests",                  default: true, null: false
    t.integer  "extension_weeks_on_resubmit_request",  limit: 4,    default: 1,    null: false
    t.boolean  "allow_student_change_tutorial",                     default: true, null: false
    t.boolean  "assessment_enabled",                                default: true
    t.integer  "overseer_image_id",                    limit: 4
  end

  add_index "units", ["overseer_image_id"], name: "index_units_on_overseer_image_id", using: :btree
  ...
  create_table "webcal_unit_exclusions", force: :cascade do |t|
    t.integer "webcal_id", limit: 4, null: false
    t.integer "unit_id",   limit: 4, null: false
  end
  ...
  add_index "webcal_unit_exclusions", ["webcal_id"], name: "fk_rails_d5fab02cb7", using: :btree
  ...
  create_table "webcals", force: :cascade do |t|
    ...
    t.integer "user_id",             limit: 4
    t.integer "reminder_time",       limit: 4
    t.string  "reminder_unit",       limit: 255
  end
